...
public class FirebaseEventManager {
    ...
    public void shareAppEvent(String deviceId) {
        Bundle bundle = new Bundle();
        bundle.putString(DEVICE_ID, deviceId);
        analytics.logEvent(SHARE_APP, bundle);
    }

    public void searchQueryEvent(String query){
        Bundle bundle = new Bundle();
            bundle.putString(SEARCH_QUERY, query);
            analytics.logEvent(SEARCH_EVENT, bundle);
    }
}
